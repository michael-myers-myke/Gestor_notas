...
import "./tareasDeshabilitadas.css"
  ...
  return (
    <div className="tareas-page">
      ...
      <main className="main-content">
        <h1 className="page-title">Tareas Deshabilitadas</h1>

        <div className="section-header">
          <h2 className="section-title">Tus Tareas Deshabilitadas</h2>
        </div>
            ...
            {filteredTareas.map((tarea) => (
              <div key={tarea.id} className={`tarea-card ${!tarea.enabled ? "disabled" : ""}`}>
                ...
                <div className="card-actions">
                  ...
                  <button
                    className="disable-button-Deshabilitadas"
